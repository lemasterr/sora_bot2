...
const defaultConfig = (): Config => ({
  ...
  ffmpegPreset: 'medium',
  promptDelayMs: 2000,
  automatorDelayMs: 1000,
  draftTimeoutMs: 60_000,
  downloadTimeoutMs: 300_000,
  maxParallelSessions: 2,
  automatorRetryCount: 2,
  autoSendDownloads: false,
  autoCleanupDownloads: false,
  autoCleanupProfiles: false,
  watermarkTemplatePath: '',
  watermarkConfidence: 0.5,
  watermarkFrames: 4,
  watermarkDownscale: 1,
  chromeProfiles: [],
